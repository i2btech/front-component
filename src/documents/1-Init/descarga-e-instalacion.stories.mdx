...
Después de descargar e instalar puede ver la documentación de forma local ingresando a: ** http://localhost:65200 ** y de forma remota ingresando a https://i2blab.github.io/front-component/

En la siguiente ruta local puedes encontrar una demo: ** http://localhost:3000 **